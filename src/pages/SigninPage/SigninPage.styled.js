...
export const SigninModalBlock = styled.div`
  display: block;
  margin: 0 auto;
...
export const SigninModalTtl = styled.div`
  text-align: center;
  font-size: 20px;
  font-weight: 700;
  line-height: 30px;
...
export const SigninModalInput = styled.input`
  margin-bottom: 7px;
  width: 100%;
  min-width: 100%;
  border-radius: 8px;
...
export const SigninModalBtnEnter = styled.span`
  width: 100%;
  height: 30px;
