...
export const HeaderBtnMainNewText = styled.p`
  color: #ffffff;
`;
...
export const HeaderPopUserSetMail = styled.p`
  ...
  margin-bottom: 10px;
`;
export const HeaderPopUserSetThemeP = styled.p`
  color: #000;
  font-size: 14px;
  line-height: 21px;
  letter-spacing: -0.14px;
`;
export const HeaderPopUserSetThemeInput = styled.input`
  position: relative;
  width: 24px;
  height: 13px;
  border-radius: 100px;
